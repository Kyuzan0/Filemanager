    ...
    <div class="settings-dialog d-flex flex-col"
        ...
        <div class="settings-body flex-1 overflow-y-auto">
            ...
            <div class="settings-panel" id="settings-panel-general" role="tabpanel"
                ...
                <!-- Extension Settings -->
                <div class="setting-row mb-4">
                    <h3 class="setting-label mb-2 font-semibold" style="font-size: 0.9375rem;">Ekstensi File</h3>
                    <p class="setting-hint mb-3">Kontrol ekstensi file yang diizinkan atau diblokir. Pisahkan dengan koma.</p>
